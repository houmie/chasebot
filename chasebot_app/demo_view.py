...
def demo(request):
    ...
    cotton = profile.company.dealtemplate_set.create(deal_name = _(u'Cotton Industrial Deal'), deal_description = _(u'Providing the basic cotton mill machinary for cotton farmers.'), currency = Currency.objects.get(pk=1), price = 4499.99, sales_term = SalesTerm.objects.get(pk=1), quantity = 1)
    ...
    call2 = c1.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=7, hours=4), subject=_(u'Followup Offer'), notes=_(u'%(name)s would commit if there is a discount of 5%% on the deal.') % {'name' : 'John'})
    ...
    call3 = c1.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=4, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s has accepted the offer. Its a win.') % {'name' : 'John'})
    ...
    call1 = c2.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s looks for a cloud solution for her B2B business. I will try to see if our Website package might interest her.') % {'name' : 'Ashley' })
    ...
    call2 = c2.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'%(name)s will consider the offer and needs some time to think about it.') % {'name' : 'Ashley'})
    ...
    call3 = c2.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=5, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s doesn\'t seem to be interested any longer. Its a loss.') % {'name' : 'Ashley'})
    ...
    call2 = c3.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'Made some progress with the deal. Trying to convince %(name)s of the lunch deal quality. Deal still in progress...') % {'name' : 'Silvia'})
    ...
    call1 = c4.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s has a new fashion shop and might be interested in our quality shirts and ties as a package.') % {'name' : 'Michael'})
    ...
    call2 = c4.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=4, hours=1), subject=_(u'Followup Offer'), notes=_(u'I offered him a discount of 5%%. %(name)s will consider the offer and needs some time to think about it.') % {'name' : 'Michael'})
    ...
    call3 = c4.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=8, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'%(name)s is happy with discount and would like to purchase ten packages.') % {'name' : 'Michael'})
    ...
    call1 = c5.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s is investing into a cotton mill factory and might be a potential client.') % {'name' : 'Harry'})
    ...
    call2 = c5.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=1, hours=4), subject=_(u'Followup Offer'), notes=_(u'%(name)s doesn\'t need the 10 cotton saws. I agreed to remove it from the package and offer a 25%% discount. He needs now some time to think about it.') % {'name' : 'Harry'})
    ...
    call3 = c5.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=3, hours=2), subject=_(u'Second Followup Offer'), notes=_(u'%(name)s is happy with the new deal and price. Its a win.') % {'name' : 'Harry'})
    ...
    call1 = c6.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s looks for a cloud solution for her B2B business. I will try to see if our Website package might interest her.') % {'name' : 'Rosa' })
    ...
    call2 = c6.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'%(name)s will consider the offer and needs some time to think about it. ') % {'name' : 'Rosa'})
    ...
    call3 = c6.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=5, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s seems to be interested. Its a win') % {'name' : 'Rosa'})
    ...
    call2 = c7.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=7, hours=4), subject=_(u'Followup Offer'), notes=_(u'%(name)s would commit if there is a discount of 5%% on the deal.') % {'name' : 'Hugo'})
    ...
    call3 = c7.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=4, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s has accepted the offer. Its a win.') % {'name' : 'Hugo'})
    ...
    call2 = c8.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'Made some progress with the deal. Trying to convince %(name)s of the lunch deal quality. Deal still in progress...') % {'name' : 'Homer'})
    ...
    call3 = c8.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'%(name)s is happy with the price. Its a win.') % {'name' : 'Homer'})
    ...
    call1 = c9.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s is investing into a cotton mill factory and might be a potential client.') % {'name' : 'William'})
    ...
    call3 = c9.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=3, hours=2), subject=_(u'Second Followup Offer'), notes=_(u'%(name)s is happy with the new deal and price. Its a win.') % {'name' : 'William'})
    ...
    call1 = c10.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s looks for a cloud solution for her B2B business. I will try to see if our Website package might interest her.') % {'name' : 'Matthew' })
    ...
    call2 = c10.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=2, hours=1), subject=_(u'Followup Offer'), notes=_(u'%(name)s will consider the offer and needs some time to think about it.') % {'name' : 'Matthew'})
    ...
    call3 = c10.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=5, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s doesn\'t seem to be interested any longer. Its a loss.') % {'name' : 'Matthew'})
    ...
    call1 = c11.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s has a new fashion shop and might be interested in our quality shirts and ties as a package.') % {'name' : 'Jonas'})
    ...
    call2 = c11.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=4, hours=1), subject=_(u'Followup Offer'), notes=_(u'I offered him a discount of 5%%. %(name)s will consider the offer and needs some time to think about it.') % {'name' : 'Michael'})
    ...
    call3 = c11.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=8, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'%(name)s is happy with discount and would like to purchase ten packages.') % {'name' : 'Michael'})
    ...
    call2 = c12.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=7, hours=4), subject=_(u'Followup Offer'), notes=_(u'%(name)s would commit if there is a discount of 5%% on the deal.') % {'name' : 'Kaylee'})
    ...
    call3 = c12.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=4, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'After another conversation, %(name)s has accepted the offer. Its a win.') % {'name' : 'Kaylee'})
    ...
    call1 = c13.conversation_set.create(conversation_datetime=timezone.now(), subject=_('Initial Offer'), notes=_('%(name)s has a new fashion shop and might be interested in our quality shirts and ties as a package.') % {'name' : 'Tamara'})
    ...
    call2 = c13.conversation_set.create(conversation_datetime=call1.conversation_datetime + timezone.timedelta(days=4, hours=1), subject=_(u'Followup Offer'), notes=_(u'I offered him a discount of 5%%. %(name)s will consider the offer and needs some time to think about it.') % {'name' : 'Tamara'})
    ...
    call3 = c13.conversation_set.create(conversation_datetime=call2.conversation_datetime + timezone.timedelta(days=8, hours=3), subject=_(u'Second Followup Offer'), notes=_(u'%(name)s is happy with discount and would like to purchase ten packages.') % {'name' : 'Tamara'})
