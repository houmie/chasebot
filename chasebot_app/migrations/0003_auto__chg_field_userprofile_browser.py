...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.browser'
        db.alter_column('chasebot_app_userprofile', 'browser', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.browser'
        db.alter_column('chasebot_app_userprofile', 'browser', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
