...
cur.execute("INSERT INTO chasebot_app_userprofile (user_id, company_id, is_cb_superuser, license_id, timezone, browser, is_log_active) VALUES (1, 1, TRUE, 6, 'Europe/London', 'x', TRUE);")
