...
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Coffee', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Tea', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Sandwich', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Fruit Bowl', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Cake', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Soft Drink', 2);")
cur.execute("INSERT INTO chasebot_app_salesitem (item_description, company_id) VALUES ('Chips', 2);")
